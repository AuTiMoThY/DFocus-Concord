...
//app
 ...
 ?>
<section class="banner" style="background-image: url('<?php path_au('img'); ?>banner-futures.jpg')">
	...
	<section class="row1">
		<div class="wrapper small">
			<div class="cnt editorDF">
				<img src="<?php path_au('temp'); ?>tem7.jpg" alt="" class="temporary">
			</div>
		</div>
	</section>
