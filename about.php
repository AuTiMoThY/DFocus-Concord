...
<main class="">
				...
				<div class="wrapper small">
					<ul class="futures_intro-list cf">
						<li id="futuresSec1Intro" class="futures_intro-item">
							<p class="txt-2">期貨經理事業係指經營接受特定人委任，對委任人之委託交易資產，就有關期貨交易、期貨相關現貨商品或其他經主管機關核准項目之交易或投資為分析、判斷，並基於該分析、判斷，為委任人執行期貨交易之業務者。</p>
						...
						<li id="futuresSec2Intro" class="futures_intro-item">
							<p class="txt-2">國內期貨信託事業係以向不特定人或符合主管機關所定資格條件之人募集期貨信託基金發行受益憑證，並運用期貨信託基金從事交易或投資之事業。聚集更多的小額資金，配合專業穩健的研究投資團隊，為廣大投資人進行審慎與安全的期貨交易，提供一個可參與國內外期貨市場的管道。</p>
							<div class="change_bar">
								<a href="javascript:void 0;" class="btn btn-goPrev ib"></a>
						...
						<li id="futuresSec3Intro" class="futures_intro-item">
							<p class="txt-2">期貨顧問事業業務係以接受委任，對期貨交易、期貨信託基金、期貨相關現貨商品或其他經主管機關公告與核准項目之交易或投資有關事項提供研究分析意見或建議咨詢服務，與執行前款有關期貨交易或投資之出版品發行及舉辦講習者。</p>
							<div class="change_bar">
								<a href="javascript:void 0;" class="btn btn-goPrev ib"></a>
	...
	<section id="capitalPreservation" class="row3">
		<div class="wrapper small">
			...
			<div class="cnt">
				<p class="txt-1_3">投資基金要懂得資產配置、分析景氣循環、研判買賣時點…十八般武藝精通還不夠？本著自己也是投資人，我們希望基金能滿足哪些投資需求？提供哪些附加價值？康和多空成長期貨信託基金從這樣的想法出發，由專業管理團隊替您考量資產配置、提高投資效率、結合交易策略降低市場風險，追求績效多空成長、穩健增值，讓投資人不論面對多頭、空頭，景氣好與壞，都能掌握獲利契機，滿足投資需求，實踐人生夢想！</p>
			</div>
