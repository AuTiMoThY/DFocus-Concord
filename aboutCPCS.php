...
<!-- 				<p class="txt-1_3">
	...
	<section class="row2 fullbg">
		<div class="bg"></div>
		<div class="wrapper small">
			<hgroup class="txtImg_title-title-cp2">
				<h2 class="hidden" data-lang="tw">風險管理是投資的不二法門</h2>
			</hgroup>
			<div class="cnt">
		...
		<div class="wrapper cf">
			<div class="col-2">
				...
				<div class="row2 cp_computer-intro">
					<div class="content">
						<h3 class="txtImg_title-title-cpComputer2 hide_txt">投資報酬率計算機</h3>
						...
						<a href="http://www.pjhuang.tw/72rule/annuity_rate.php" class="btn btn-goComputer txt-1 link-2" target="_blank">理財規劃試算器</a>
					</div>
				</div>
				<div class="row3">
			...
			<div class="col-2">
				<div class="row1 cp_computer-intro">
					<div class="content">
						<h3 class="txtImg_title-title-cpComputer1 hide_txt">讓我們撐起您的資產保護傘</h3>
				...
				<div class="row3 cp_computer-intro">
					<div class="content">
						<h3 class="txtImg_title-title-cpComputer3 hide_txt">定期定額，小錢也能立大功</h3>
						...
						<a href="http://www.moneydj.com/funddj/yb/yp503002.djhtm" class="btn btn-goComputer txt-1 link-2" target="_blank">理財規劃試算器</a>
					</div>
				</div>
			</div>
		</div>
